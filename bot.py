...
# Импорт обработчиков
from handlers.bath import register_bath, create_bath_event, button_callback, confirm_bath_registration, handle_payment_confirmation, admin_confirm_payment, admin_decline_payment, handle_cash_payment, handle_deep_link
...
from handlers.admin import mark_paid, add_subscriber, remove_subscriber, update_commands, export_profiles, mention_all, stats, mark_visit, clear_db
...
if __name__ == "__main__":
    ...
    application.add_handler(CommandHandler("history", stats))
    application.add_handler(CommandHandler("visits", stats))
